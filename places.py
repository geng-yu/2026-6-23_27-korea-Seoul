...
PLACES = {
    ...
    "wacky_willy": {
        ...
        "lat": 37.5510458, "lng": 126.9204201,
        "hours": "12:00-21:00 每天開",
        "phone": "070-8848-3316",
        "note": "塗鴉插畫印花。4.6/580+ 評論。",
        "priority": True,
    },
    "thisisneverthat": {
  ...
  # ================================================================
# 貼到 places.py 的 PLACES dict 裡（建議放在 bukchon 後面）
# ================================================================

    "changdeokgung": {
        "name": "昌德宮", "name_kr": "창덕궁",
        "area": AREA_ANGUK, "cat": "sight",
        "address": "서울 종로구 율곡로 99",
        "lat": 37.5794309, "lng": 126.9910426,
        "hours": "09:00-18:00 (週一公休)",
        "phone": "02-3668-2300",
        "note": "⭐ 4.6/13,800+ 評論。UNESCO 世界遺產，比景福宮安靜，"
                "穿韓服免門票 ₩3,000。"
    ...
    # ================================================================
    "lotte_dutyfree_main": {
        "name": "樂天免稅店 明洞本店", "name_kr": "롯데면세점 명동본점",
        "area": AREA_MYEONGDONG, "cat": "shop", "sub": "免稅店",
        "address": "서울 중구 을지로 30",
        "lat": 37.5647, "lng": 126.9817,
        "hours": "09:30-20:00 每天開",
        "phone": "02-759-6600",
        "note": "⭐ 4.2/770+ 評論。樂天百貨 9-12 樓，是樂天主店、品項最全。"
                "⚠️ 要刷護照「sign in」入場、人多會排 2-3 小時限流。"
                "建議護照、登機證 (用 LJ737 訂位代號)、信用卡都準備好。"
                "💡 B1 直接連接乙支路入口站 8 號出口 (內部地下通道)，"
                "逛完直接搭 2 號線回弘대不用走地面。"
                "🛍️ 領貨地點：T1 Gate 45 / T2 在「免稅品提貨整合取號機」。",
        "priority": True,
    },
    "shinsegae_main": {
