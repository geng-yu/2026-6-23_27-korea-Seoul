...
# === 聖水洞主行程 (shop) — 衣服 / 鞋子 / 墨鏡 ===
    ...
    "bongsan": {
        ...
        "hours": "10:30-20:00 (週五六到 20:30)",
        "phone": "1588-1234",
        "note": "⭐優先。4.3/12,800+ 評論。3 棟相連：The Estate (14F 主館，含 8-11F 免稅店)、"
                "The Reserve (6F 精品)、The Heritage (5F 經典)，B1 美食街/巴黎可頌排隊名店。",
        "priority": True,
    },
    # ==============================
...
# === 東大門 / 鍾路 (jin_okhwa 一隻雞) ===
    ...
    "myungdong_chicken": {
        ...
        "hours": "10:30-22:15",
        "phone": "02-318-2468",
        "note": "4.9/750+ 評論。陳玉華太遠的話來這間，明洞內就有，"
                "刀削麵 + 一隻雞鍋，平板點餐有中英文。",
    },
    ...
    "menten_ramen": {
        ...
        "lat": 37.5619547, "lng": 126.9885760,
        "hours": "週一、日休 / 平日 11:40-14:30, 17:40-19:30",
        "note": "4.4/450+ 評論。明洞拉麵秘藏，只 8 個座位。"
                "醬油拉麵主推，要兩顆蛋。⚠️ 別在最後一輪點單前 30 min 來。",
    },
    ...
    "myeongdong_hotteok": {
        ...
        "lat": 37.5611754, "lng": 126.9818543,
        "hours": "12:00-21:00",
        "note": "4.8/40+ 評論。明洞街頭老奶奶的家傳糖餅，鐵盤烤不油炸，"
                "1 個 ₩2,000 / 2 個 ₩5,000。比連鎖炸的好吃。",
    },
    ...
    "hwa_tteok_gopchang": {
        ...
        "note": "4.2/290+ 評論。明洞便宜辣炒年糕，加章魚/血腸/起司。較辣，"
                "怕辣可點原味。樓梯陡無扶手。",
    },
        "doota_mall": {
        ...
        "phone": "02-3398-3333",
        "note": "4.4/1,800+ 評論。從明洞搭 4 號線 1 站到東大門。"
                "外國人退稅快、Olive Young 超大間。⚠️ 頂樓散客攤位喊價要小心。",
    },
    # ==============================
    # 備案 — 安國/北村
    # ==============================
    ...
    "tongin_market": {
        ...
        "hours": "07:00-21:00 (便當咖啡週二休)",
        "phone": "02-722-0911",
        "note": "經福宮西邊 15 min 內，必體驗：₩10,000 換 20 個銅板，"
                "拿便當盒去市場攤位用銅板換菜，回 2F 自助加湯吃，平日去較鬆。",
    },
