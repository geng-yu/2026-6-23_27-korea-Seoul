...
PLACES = {
    ...
    "kyochon": {
        ...
        "hours": "12:00-01:30",
        "phone": "02-338-1300",
        "note": "國民炸雞品牌，醬油蒜味/紅辣味，走路 3 min 從飯店",
    },
    "baeknyeon": {
    ...
    "mangwon_croquette": {
        ...
        "phone": "02-336-7412",
        "note": "望遠市場地標。馬鈴薯沙拉可樂餅 ₩1,000 招牌，10:00 出爐最熱。⚠️ 週末休",
    },
    "kyuseu_chicken": {
    ...
    "kimchi_wang_mandu": {
        ...
        "note": "市場入口的招牌蒸餃，泡菜豬肉口味必點 5 個 ₩5,000",
    },
    "yeon_mandu": {
    ...
    "jin_okhwa": {
        ...
        "hours": "10:30-01:00",
        "phone": "02-2275-9666",
        "note": "老店元祖，桌上現滾。Tip：先丟馬鈴薯+蒜+蔥，最後加手打麵。等位 20 min",
        "priority": True,
    },
    "myungdong_chicken": {
    ...
    "hyodam_dakhanmari": {
        ...
        "hours": "10:30-22:15",
        "phone": "02-318-2468",
        "note": "陳玉華太遠的話來這間，明洞內就有。刀削麵 + 一隻雞鍋，平板點餐有中英文",
    },
    "menten_ramen": {
