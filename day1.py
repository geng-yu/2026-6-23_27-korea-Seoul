...
def show_day():
    ...
    <div class="stop-card">
      ...
      <div class="body">
        <div class="top-row">
          <h4>10:40 台中 → 14:15 仁川 T2 · 2h35m</h4>
        </div>
    ...
    <div class="stop-card">
      ...
      <div class="body">
        ...
        <div class="top-row" style="margin-top:8px;">
          <h4 style="font-size:14px; font-weight:800;">AREX (T2 → 弘大 · 홍대입구)</h4>
          <div class="nav-btns">
            ...
            <a class="nav-btn n" href="nmap://search?query=%ED%99%8D%EB%8C%80%EC%9E%85%EA%B5%AC%EC%97%AD%209%EB%B2%88%20%EC%B6%9C%EA%B5%AC&appname=seoul_trip_2026" title="NAVER">N</a>
          </div>
        </div>
        ...
        <div class="top-row" style="margin-top:10px;">
          <h4 style="font-size:14px; font-weight:800;">9 號出口 → 9 Brick Hotel</h4>
          <div class="nav-btns">
